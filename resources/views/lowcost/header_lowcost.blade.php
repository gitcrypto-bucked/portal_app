                ...
                <ul class="navbar-nav flex-grow-2  ms-auto">
                    ...
                    <li class="nav-item">
                        ...
                        @if(Route::has('login') & !auth()->user())
                            <button class="btn " type="submit" onclick="location.href='/login'" style="font-size:14px !important;">
                                <i class="fas fa-sign-in"></i>&nbsp;Login
                            </button>
                        @endif
                        @if (Auth::check())
                            <button class="btn " type="submit" onclick="location.href='/logout'" style="font-size:14px !important;">
